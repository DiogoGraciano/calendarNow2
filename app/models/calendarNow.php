...
class calendarNow extends model {
    ...
    public static function table(){
        return (new table(self::table,comment:"Tabela do calendarnow"))
                ...
                ->addColumn((new column("cep","VARCHAR",8))->setComment("CEP"))
                ...
                ->addColumn((new column("bairro","VARCHAR",300))->setComment("Bairro"))
                ->addColumn((new column("rua","VARCHAR",300))->setComment("Rua"))
                ->addColumn((new column("numero","INT"))->setComment("Numero"))
