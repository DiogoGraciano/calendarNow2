...
final class menu extends model {
    ...
    public static function seed(){
        ...
        if(!$menu->addLimit(1)->selectColumns("id")){
            ...
            $menu->store();
            $menu = new self;
            $menu->controller = "financeiro";
            $menu->tipo_usuario = json_encode([1]);
            $menu->nome = "Financeiro";
            $menu->class_icone = "fa-solid fa-money-bills";
            $menu->ordem = 10;
            $menu->target_blank = 0;
            $menu->ativo = 1;
            $menu->store();
            ...
            $menu->tipo_usuario = json_encode([1]);
            $menu->nome = "DRE";
            $menu->class_icone = "fa-solid fa-file-invoice-dollar";
            $menu->ordem = 13;
            $menu->target_blank = 0;
            $menu->ativo = 1;
            $menu->store();
